...
export class ProductsView extends Component {
    ...
    update(state) {
        ...
        this.container.innerHTML = `
            ...
            <div class="products-screen" style="padding: 0 16px;">
